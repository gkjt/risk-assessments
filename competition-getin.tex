...
\newcommand{\harm}[8]{
% Harm, risk groups, control measures, responsible persons, inherent likelyhood, inhernt severity, residual likelihood, residual severity
#1 & #2 & #3 & #4 & #5 & #6 & \the\numexpr#5*#6\relax & #7 & #8 & \the\numexpr#7*#8\relax \\
\hline
}
...
\begin{longtable}{|p{12em}|p{4em}|p{18em}|p{8em}|*3{p{2em}|} *3{p{2em}|}}
\hline
